...
HD_PWD='C:/Users/ammic/OneDrive/Documents/GitHub/Lab06/Lab06_project/Lab06_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sseg1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sseg1_wrapper.tcl -notrace
